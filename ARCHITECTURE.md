...
The private transaction layer reuses the same entity, claim, exact-passage, source-rank, audit-ledger, tenant, purpose, and role controls as counterparty diligence. Private-sale cases orchestrate seller identity, authority, provenance, attribution, restitution, cultural-property, export, sanctions, and condition gates. They do not duplicate evidence or infer clearance from client-side demo state.
