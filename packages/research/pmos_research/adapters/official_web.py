...
class OfficialWebAdapter:
    def __init__(self,resolver=None):
        ...
        self.max_bytes=int(os.getenv("PMOS_MAX_RESPONSE_BYTES","2000000"))
        self.client=httpx.Client(headers={"User-Agent":self.user_agent,"Accept":"text/html,application/xhtml+xml"},follow_redirects=False,timeout=20)
